  ...
  const supportCards = [
    {
      icon: HelpCircle,
      title: 'FAQ',
      desc: '자주 묻는 질문, 공지사항, 이용가이드를 확인하세요',
      path: '/help-center',
      gradient: 'from-indigo-500 to-blue-600',
      badge: '고객센터',
    },
    {
      icon: Shield,
      title: '개인정보처리방침',
      desc: '디컴소프트 개인정보보호 정책 및 처리 방침 안내',
      path: '/privacy-policy',
      gradient: 'from-violet-500 to-purple-600',
      badge: '정책',
    },
    {
      icon: FileCheck,
      title: '이용약관',
      desc: 'AI 한글 에디터 서비스 이용약관 및 회원 규정',
  ...
  return (
    <div className="flex-1 overflow-auto bg-slate-50">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8 sm:py-12 relative z-20 -mt-10">
        ...
        {/* ── 고객지원 및 정책 ── */}
        <div className="mb-8 sm:mb-12 animate-in slide-in-from-bottom-12 fade-in duration-500 delay-400 fill-mode-both">
          <div className="flex items-center gap-2 mb-4 sm:mb-6">
            <div className="w-6 h-6 bg-blue-100 rounded-lg flex items-center justify-center shrink-0 border border-blue-200">
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-1">
                      <h3 className="text-slate-800 font-bold text-sm">{card.title}</h3>
                      <span className="text-[10px] px-1.5 py-0.5 rounded bg-indigo-50 border border-indigo-100 text-indigo-600 font-semibold shrink-0">
                        {card.badge}
                      </span>
                    </div>
                    <p className="text-slate-500 text-xs leading-relaxed font-medium">{card.desc}</p>
