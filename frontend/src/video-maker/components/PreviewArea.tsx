...
export const PreviewArea: React.FC<PreviewAreaProps> = ({ activeSlide, aspectRatio, subtitleStyle }) => {
  ...
  if (!activeSlide) {
    return (
      <div className="flex-1 bg-[#f1f5f9] flex items-center justify-center text-slate-400 h-full">
  ...
  return (
    <div className="flex-1 bg-[#f1f5f9] p-4 sm:p-6 flex flex-col items-center justify-center relative overflow-hidden h-full">
      {/* 화면 비율 컨테이너 */}
      <div
        ref={containerRef}
        className="relative bg-black shadow-sm rounded-lg overflow-hidden border border-slate-200 transition-all duration-300"
        style={{
